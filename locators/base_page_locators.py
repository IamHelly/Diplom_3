...
class BasePageLocators:
    ...
    LINK_CONSTRUCTOR = (By.XPATH, './/p[contains(text(), "Конструктор")]/parent::a')  # ссылка для перехода в раздел "Конструктор"
    LINK_ORDER_FEED = (By.XPATH, './/p[contains(text(), "Лента Заказов")]/parent::a')  # ссылка для перехода в раздел "Лента заказов"
